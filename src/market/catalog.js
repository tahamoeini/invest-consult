...
export const INSTRUMENT_REGISTRY = Object.freeze({
  dollar: Object.freeze({ id: "dollar", sleeveId: "fx", marketKey: "dollar", unit: "TOMAN", quoteType: "direct", recommendationAssetId: "currency" }),
  gold: Object.freeze({ id: "gold", sleeveId: "gold", marketKey: "gold", unit: "gram", quoteType: "direct", recommendationAssetId: "gold" }),
  silver: Object.freeze({ id: "silver", sleeveId: "commodities", marketKey: "silver", unit: "gram", quoteType: "direct", recommendationAssetId: "silver" }),
  bitcoin: Object.freeze({ id: "bitcoin", sleeveId: "crypto", marketKey: "bitcoin", unit: "coin", quoteType: "derived" }),
  ethereum: Object.freeze({ id: "ethereum", sleeveId: "crypto", marketKey: "ethereum", unit: "coin", quoteType: "derived" }),
  tether: Object.freeze({ id: "tether", sleeveId: "crypto", marketKey: "tether", unit: "coin", quoteType: "derived" }),
  platinum: Object.freeze({ id: "platinum", sleeveId: "commodities", marketKey: "platinum", unit: "gram", quoteType: "derived" }),
  palladium: Object.freeze({ id: "palladium", sleeveId: "commodities", marketKey: "palladium", unit: "gram", quoteType: "derived" }),
  copper: Object.freeze({ id: "copper", sleeveId: "commodities", marketKey: "copper", unit: "gram", quoteType: "derived" }),
  bourseIndex: Object.freeze({ id: "bourseIndex", sleeveId: "iranEquity", marketKey: "bourseIndex", unit: "point", quoteType: "direct", tradable: false }),
});
